      ...
      <div className="relative flex h-screen items-center justify-center p-4 overflow-hidden animate-bg-flip">
        ...
        <div className="relative z-10 w-full max-w-[400px] border-[6px] border-black bg-white shadow-[20px_20px_0px_0px_rgba(0,0,0,1)]">
          ...
          <div className="border-b-[6px] border-black bg-cyan-400 p-8 text-center">
            <h1 className="text-5xl font-black uppercase italic text-black tracking-tighter">Register</h1>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-5 p-8">
            ...
            <div className="space-y-2">
              <label className="text-lg font-black uppercase text-black italic">Username</label>
              <input
            ...
            {/* Email */}
            <div className="space-y-2">
              <label className="text-lg font-black uppercase text-black italic">Email</label>
              <input
                type="email"
            ...
            {/* Password */}
            <div className="space-y-2">
              <label className="text-lg font-black uppercase text-black italic">Password</label>
              <input
                type="password"
                placeholder="••••••••"
                value={password}
          ...
          <div className="border-t-[6px] border-black p-4 bg-black text-white text-center font-bold text-sm uppercase">
            Already a member? <span className="underline cursor-pointer hover:text-cyan-400 transition-colors">Login here</span>
          </div>
