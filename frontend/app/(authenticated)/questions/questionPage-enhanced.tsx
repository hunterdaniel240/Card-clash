                ...
                <div className="border-[6px] border-black bg-white shadow-[20px_20px_0px_0px_rgba(0,0,0,1)] w-96">
                  ...
                  <div className="p-6 space-y-4">
                    <input
                      ...
                      className="border-4 border-black p-3 w-full font-bold text-black placeholder-black/30 outline-none focus:bg-yellow-50 focus:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all"
                    />
                    ...
                    <div className="border-4 border-black p-4 space-y-2">
                      <p className="font-black uppercase text-sm">Correct Answer</p>
                      <div className="flex flex-wrap gap-4">
                        {["A", "B", "C", "D"].map((letter) => (
                          <label key={letter} className="flex items-center gap-2 cursor-pointer font-bold">
                            <input
                              type="radio"
                              name="correct_option"
                              value={letter}
